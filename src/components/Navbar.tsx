      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 sm:h-20">
          ...
          <div className="hidden md:flex items-center gap-8">
            <a href="#features" className="text-sm font-medium text-slate-600 dark:text-slate-300 hover:text-[#0b24f3] transition-colors">Features</a>
            <a href="#stats" className="text-sm font-medium text-slate-600 dark:text-slate-300 hover:text-[#0b24f3] transition-colors">Stats</a>
            <a href="#trust" className="text-sm font-medium text-slate-600 dark:text-slate-300 hover:text-[#0b24f3] transition-colors">Security</a>
            <a href="#footer" className="text-sm font-medium text-slate-600 dark:text-slate-300 hover:text-[#0b24f3] transition-colors">Contact</a>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            {user ? (
              ...
              <div className="hidden sm:flex items-center gap-2">
                ...
                <Link to="/signup" className="px-4 py-2 rounded-lg text-sm font-semibold text-white bg-[#0b24f3] hover:bg-[#0b24f3]/80 shadow-lg shadow-[#0b24f3]/20 hover:scale-105 transition">Get Started</Link>
              </div>
            )}
          ...
          <div className="md:hidden pb-4 space-y-2 animate-in slide-in-from-top-2 duration-200">
            ...
            {user ? (
              ...
              <>
                ...
                <Link to="/signup" className="block px-3 py-2 rounded-lg text-sm font-semibold bg-[#0b24f3] text-white text-center">Get Started</Link>
              </>
            )}
          </div>
        )}
