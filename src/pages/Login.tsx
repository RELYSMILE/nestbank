...
<div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-slate-900 via-blue-950 to-slate-900 relative overflow-hidden p-12 items-center justify-center">
        <div className="absolute inset-0">
          <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-[#0b24f3] opacity-30 rounded-full blur-[120px]" />
        </div>
        <div className="relative z-10 max-w-md text-white">
          <Link to="/" className="flex items-center gap-2.5 mb-8">
            ...
            <span className="text-2xl font-black">NEST<span className="text-[#0b24f3]">BANK</span></span>
          </Link>
          ...
          <div className="mt-12 space-y-4">
            {['Instant transfers in 0.2 seconds', '256-bit end-to-end encryption', 'Available in 120+ countries'].map((t) => (
              <div key={t} className="flex items-center gap-3">
                <div className="w-8 h-8 rounded-full bg-[#0b24f3]/20 flex items-center justify-center">
                  <div className="w-2 h-2 bg-[#0b24f3] rounded-full" />
                </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6 sm:p-12 bg-white dark:bg-slate-950">
        <div className="w-full max-w-md">
          <Link to="/" className="inline-flex items-center gap-2 text-sm text-slate-500 hover:text-[#0b24f3] mb-8"><ArrowLeft className="w-4 h-4" /> Back to home</Link>
          ...
          <p className="mt-8 text-sm text-center text-slate-500">
            Don't have an account? <Link to="/signup" className="text-[#0b24f3] font-semibold hover:underline">Create one</Link>
          </p>
        </div>
      </div>
    </div>
